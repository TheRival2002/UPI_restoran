...
('Bruschetta', 'Toasted bread topped with diced tomatoes, basil, and olive oil.', 5.49, 'bruschetta.jpeg', 1),
('Caesar Salad', 'Classic Caesar salad with romaine lettuce, croutons, and Parmesan.', 6.99, 'caesar_salad.jpeg', 1),
('Garlic Bread', 'Freshly baked bread topped with garlic butter and herbs.', 3.99, 'garlic_bread.jpeg', 1),
('Stuffed Mushrooms', 'Mushrooms filled with a cheesy herb mixture.', 5.99, 'stuffed_mushrooms.jpeg', 1),
('Mozzarella Sticks', 'Fried mozzarella sticks served with marinara sauce.', 4.99, 'mozzarella_sticks.jpeg', 1),
...
('Greek Salad', 'Salad with tomatoes, cucumber, olives, and feta cheese.', 6.99, 'greek_salad.jpeg', 1),
('Shrimp Cocktail', 'Chilled shrimp served with tangy cocktail sauce.', 7.99, 'shrimp_cocktail.jpeg', 1),
