...
VALUES
('Spring Rolls', 'Crispy rolls filled with vegetables and served with sweet chili sauce.', 4.99, NULL, 1),
('Bruschetta', 'Toasted bread topped with diced tomatoes, basil, and olive oil.', 5.49, NULL, 1),
('Caesar Salad', 'Classic Caesar salad with romaine lettuce, croutons, and Parmesan.', 6.99, NULL, 1),
('Garlic Bread', 'Freshly baked bread topped with garlic butter and herbs.', 3.99, NULL, 1),
('Stuffed Mushrooms', 'Mushrooms filled with a cheesy herb mixture.', 5.99, NULL, 1),
('Mozzarella Sticks', 'Fried mozzarella sticks served with marinara sauce.', 4.99, NULL, 1),
('Chicken Wings', 'Spicy and tangy chicken wings served with ranch dip.', 7.99, NULL, 1),
('Tomato Soup', 'Rich and creamy tomato soup topped with croutons.', 4.49, NULL, 1),
('Onion Rings', 'Crispy golden onion rings with a zesty dipping sauce.', 3.99, NULL, 1),
('Caprese Salad', 'Fresh mozzarella, tomatoes, and basil drizzled with balsamic.', 6.49, NULL, 1),
('Greek Salad', 'Salad with tomatoes, cucumber, olives, and feta cheese.', 6.99, NULL, 1),
('Shrimp Cocktail', 'Chilled shrimp served with tangy cocktail sauce.', 7.99, NULL, 1),
('Mini Tacos', 'Small tacos with chicken, beef, or vegetarian fillings.', 6.49, NULL, 1),
('Crab Cakes', 'Golden crab cakes served with remoulade sauce.', 8.99, NULL, 1),
('Beef Sliders', 'Mini beef burgers with cheese and special sauce.', 7.49, NULL, 1),
('Spinach Dip', 'Creamy spinach dip served with tortilla chips.', 5.49, NULL, 1),
('Potato Skins', 'Baked potato skins topped with cheese and bacon.', 6.99, NULL, 1),
('Avocado Toast', 'Toasted bread topped with smashed avocado and seasoning.', 5.99, NULL, 1),
('Deviled Eggs', 'Classic deviled eggs with a touch of paprika.', 4.49, NULL, 1),
('Nachos', 'Tortilla chips loaded with cheese, beans, and jalapenos.', 6.99, NULL, 1),

('Grilled Chicken', 'Tender grilled chicken breast served with seasonal vegetables.', 12.99, NULL, 2),
('Spaghetti Bolognese', 'Classic Italian pasta with rich meat sauce.', 10.99, NULL, 2),
('Beef Steak', 'Juicy beef steak cooked to your preference.', 16.99, NULL, 2),
('Salmon Fillet', 'Grilled salmon served with lemon butter sauce.', 14.99, NULL, 2),
('Vegetarian Pizza', 'Pizza topped with fresh vegetables and mozzarella.', 11.99, NULL, 2),
('Chicken Alfredo', 'Creamy pasta with chicken and Parmesan cheese.', 13.99, NULL, 2),
('Burger and Fries', 'Classic cheeseburger served with crispy fries.', 9.99, NULL, 2),
('Lamb Chops', 'Grilled lamb chops with mint sauce.', 18.99, NULL, 2),
('Vegetable Stir Fry', 'Stir-fried vegetables in a savory sauce.', 10.49, NULL, 2),
('Seafood Paella', 'Spanish rice dish with shrimp, mussels, and calamari.', 15.99, NULL, 2),
('Roast Beef', 'Slow-cooked roast beef with gravy and mashed potatoes.', 14.49, NULL, 2),
('Chicken Tikka Masala', 'Indian-style chicken in a creamy tomato sauce.', 12.99, NULL, 2),
('Pork Chops', 'Juicy pork chops served with apple sauce.', 13.99, NULL, 2),
('Vegetable Curry', 'Spiced vegetable curry served with steamed rice.', 11.49, NULL, 2),
('Chicken Quesadilla', 'Grilled tortilla filled with chicken and cheese.', 9.99, NULL, 2),
('Fettuccine Carbonara', 'Pasta with creamy sauce, pancetta, and Parmesan.', 12.99, NULL, 2),
('BBQ Ribs', 'Smoky barbecue ribs served with coleslaw.', 16.99, NULL, 2),
('Turkey Sandwich', 'Fresh turkey sandwich with lettuce and tomato.', 8.99, NULL, 2),
('Fish and Chips', 'Crispy battered fish served with fries.', 10.99, NULL, 2),
('Eggplant Parmesan', 'Breaded eggplant with marinara and mozzarella.', 11.99, NULL, 2),

('Chocolate Cake', 'Decadent chocolate cake with a rich ganache.', 6.99, NULL, 3),
('Cheesecake', 'Creamy cheesecake with a graham cracker crust.', 7.49, NULL, 3),
('Ice Cream Sundae', 'Vanilla ice cream with chocolate syrup and whipped cream.', 5.99, NULL, 3),
('Fruit Tart', 'Pastry crust filled with custard and topped with fresh fruits.', 6.49, NULL, 3),
('Apple Pie', 'Classic apple pie served with a scoop of vanilla ice cream.', 5.99, NULL, 3),
('Brownies', 'Fudgy chocolate brownies with a hint of espresso.', 4.99, NULL, 3),
('Tiramisu', 'Classic Italian dessert with coffee and mascarpone.', 7.99, NULL, 3),
('Panna Cotta', 'Creamy Italian dessert with a berry sauce.', 6.49, NULL, 3),
('Creme Brulee', 'Rich custard topped with caramelized sugar.', 7.49, NULL, 3),
('Churros', 'Fried dough pastries served with chocolate sauce.', 5.99, NULL, 3),
('Macarons', 'Delicate French cookies in various flavors.', 8.49, NULL, 3),
('Lemon Meringue Pie', 'Tangy lemon pie topped with toasted meringue.', 6.99, NULL, 3),
('Rice Pudding', 'Creamy rice pudding with cinnamon.', 5.49, NULL, 3),
('Peach Cobbler', 'Baked peach dessert with a buttery crust.', 6.49, NULL, 3),
('Black Forest Cake', 'Chocolate cake layered with cherries and cream.', 7.99, NULL, 3),
('Carrot Cake', 'Moist carrot cake with cream cheese frosting.', 6.99, NULL, 3),
('Banoffee Pie', 'Pie with bananas, cream, and toffee.', 7.49, NULL, 3),
('Custard Tart', 'Sweet custard in a flaky pastry shell.', 5.99, NULL, 3),
('Coconut Cake', 'Light and fluffy coconut cake with cream.', 6.49, NULL, 3),

('Coca Cola', 'Refreshing carbonated soft drink.', 1.99, NULL, 4),
('Orange Juice', 'Freshly squeezed orange juice.', 2.99, NULL, 4),
('Iced Tea', 'Chilled tea served with a slice of lemon.', 2.49, NULL, 4),
('Latte', 'Creamy coffee with steamed milk.', 3.99, NULL, 4),
('Espresso', 'Strong and rich espresso shot.', 2.49, NULL, 4),
('Smoothie', 'Blended drink with fruits and yogurt.', 4.99, NULL, 4),
('Mineral Water', 'Refreshing still or sparkling water.', 1.49, NULL, 4),
('Hot Chocolate', 'Rich and creamy hot chocolate drink.', 3.49, NULL, 4),
('Milkshake', 'Thick milkshake in various flavors.', 4.49, NULL, 4),
('Mojito', 'Classic mint and lime mocktail.', 3.99, NULL, 4),
('Pina Colada', 'Tropical drink with pineapple and coconut.', 4.99, NULL, 4),
('Green Tea', 'Hot green tea with a soothing aroma.', 2.99, NULL, 4),
('Americano', 'Espresso diluted with hot water.', 2.99, NULL, 4),
('Lemonade', 'Freshly squeezed lemonade.', 2.49, NULL, 4),
('Chai Latte', 'Spiced tea with steamed milk.', 3.99, NULL, 4),
('Sparkling Lemonade', 'Bubbly lemonade with a hint of mint.', 2.99, NULL, 4),
('Berry Smoothie', 'Mixed berry smoothie with yogurt.', 4.49, NULL, 4),
('Vanilla Shake', 'Classic vanilla milkshake.', 3.99, NULL, 4),
('Iced Coffee', 'Chilled coffee with milk and sugar.', 3.49, NULL, 4);
